...
const EditSPForm = ({ id }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await ServiceProvidersDataService.updateServiceProvider(id, updatedServiceProvider); 
  ...
  const editHandler = async () => {
    setMessage("");
    try {
      const docSnap = await ServiceProvidersDataService.getServiceProvider(id);
